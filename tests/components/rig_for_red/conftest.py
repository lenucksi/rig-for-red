...
def mock_config_entry_data():
    return {
        ...
        CONF_RGB_PRESET: DEFAULT_RGB_PRESET,
    }
...
def mock_light_services(hass):
    ...
    hass.services.async_register("switch", "turn_on", lambda x: None)
    hass.services.async_register("switch", "turn_off", lambda x: None)
    hass.services.async_register("switch", "toggle", lambda x: None)
